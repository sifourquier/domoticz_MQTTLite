...
const char *Hardware_Type_Desc(int hType)
{
	static const STR_TABLE_SINGLE	Table[] =
	{
		...
		{ HTYPE_MQTT_LITE, "MQTT_Lite Client Gateway with LAN interface and binary data" },
		...
		{ HTYPE_MQTT_LITE, "MQTT_Lite Client Gateway with LAN interface and binary datas" },
...
const char *RFX_Type_Desc(const unsigned char i, const unsigned char snum)
{
	static const STR_TABLE_SINGLE	Table[] =
	{
		...
		{ pTypeTEMP_HUM_BARO_VOLT, "Temp, Humidity, Baro, Voltage" , "temperature" },
		{ pTypeRAIN, "Rain" , "rain" },
		{ pTypeWIND, "Wind" , "wind" },
		{ pTypeUV, "UV" , "uv" },
...
const char *RFX_Type_SubType_Desc(const unsigned char dType, const unsigned char sType)
{
	static const STR_TABLE_ID1_ID2	Table[] =
	{
		...
		{ pTypeTEMP_HUM_BARO_VOLT, sTypeTHB1, "Weather Station" },
		...
		{ pTypeLimitlessLights, sSwitch2Color, "_2Color" },
