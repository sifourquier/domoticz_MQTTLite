					...
					if (typeof data.result != 'undefined') {
						...
						$.each(data.result, function (i, item) {
							...
							if (typeof obj != 'undefined') {
								...
								else if (item.SubType == "Weather Station") {
									status=item.Data;
									bigtext=item.Data;
								}
					...
					if (typeof data.result != 'undefined') {
						...
						$.each(data.result, function (i, item) {
							...
							if (typeof item.Counter != 'undefined') {
								...
								xhtm+='Battery48.png" height="48" width="48"></td>\n';
								status=item.Data;
							}
							else if (item.SubType == "Text") {
							...
							if (typeof item.Counter != 'undefined') {
								...
								xhtm += '<a class="btnsmall" onclick="ShowGeneralGraph(\'#utilitycontent\',\'ShowUtilities\',' + item.idx + ',\'' + escape(item.Name) + '\',' + item.SwitchTypeVal + ', \'' + 'Voltage' + '\');" data-i18n="Log">Log</a> ';
								if (permissions.hasPermission("Admin")) {
									xhtm += '<a class="btnsmall" onclick="EditUtilityDevice(' + item.idx + ',\'' + escape(item.Name) + '\',\'' + escape(item.Description) + '\');" data-i18n="Edit">Edit</a> ';
								}
							}
