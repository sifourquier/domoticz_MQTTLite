...
return {
	...
	matches = function (device, adapterManager)
		...
		if (not res) then
			...
			adapterManager.addDummyMethod(device, 'setLevelHue')
	...
	process = function (device, data, domoticz, utils, adapterManager)
		...
		function device.setLevelHue(percentage,hue)
			return TimedCommand(domoticz, device.name, 'Set LevelHue ' .. tostring(percentage) .. ';' .. tostring(hue))
		end
