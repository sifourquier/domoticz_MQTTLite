...
{
public:
	MQTT_Lite(const int ID, const std::string &IPAddress, const unsigned short usIPPort, const std::string &Username, const std::string &Password, const std::string &CAFile);
	~MQTT_Lite(void);
	...
	void SendMessage(const std::string &Topic, const char* Message, const int length);
